...
using UIBaseTask = Cysharp.Threading.Tasks.UniTask<UIFramework.UIBase>;
...
namespace UIFramework
{
    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        public static Vector2 ScreenPointToLocalPoint(Vector2 worldPos,RectTransform targetRect)
        {
            if (targetRect == null)
            {
                Debug.LogError("UIFrame-ScreenPointToLocalPoint : targetRect is null!");
                return Vector2.zero;
            }
